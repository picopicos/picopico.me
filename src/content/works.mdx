...
<WorkCategory title="pixiv Inc.での仕事" icon="palette">
  ...
  />
  <WorkItem
    title="pixiv百科事典のオンプレミスKubernetes移行"
    description="コンテナ基盤の整備とIaC化により、インフラ運用のプロダクトチームへの権限移譲を実現"
  />
  <WorkItem
    title="Gemini CLI と GitLab CI/CD Components による自動レビュー基盤"
    description="AIエージェントによるMRの自動レビュー・修正提案を可能にするCI/CDコンポーネントの構築と社内展開"
  />
</WorkCategory>
